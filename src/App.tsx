...
function Footer() { return <footer className="site-footer"><div className="footer-brand"><Link className="brand" to="/"><img className="brand-logo" src="/LOGO_DS_02.png" alt="" aria-hidden="true" /> <span>DUE <em>Sorelas</em></span></Link></div><div className="footer-column"><h2>Contacto</h2><a href={whatsappUrl('una pieza')} target="_blank" rel="noreferrer">WhatsApp</a></div><div className="footer-column"><h2>Información</h2><a href="/#explorar">Explorá</a><a href="/#seleccion">Selección</a></div><div className="footer-column"><h2>Sobre nosotras</h2><a href="/#quienes-somos">Quiénes somos</a></div><div className="footer-column"><h2>Comunidad</h2><a href="https://www.instagram.com/duesorelas?igsi=MWtkZWVpenhjbWJwdQ==" target="_blank" rel="noreferrer">Instagram</a></div></footer> }
